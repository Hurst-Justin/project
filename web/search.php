...
<html>
    ...
    <br>OR<br><br>
    <form>
        Search by Short Description (contains):
        <input type="text" name="short_description" value=description>
        <input type="submit" value="Search Short Description" class="button">
    </form>
